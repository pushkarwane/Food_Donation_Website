...
<head>
    <title>Food Waste Managemet System|| Manage Food Detail </title>
                  ...
                  ?>
                                <tbody>
                                    <tr data-expanded="true">
                                        ...
                                        <td><a
                                                href="edit-fooddetails.php?editid=<?php echo $row['ID']; ?>&&requestid=<?php echo $row['foodId']; ?>"><i
                                                    class="fa fa-edit" aria-hidden="true"></i></a>||<a
                                                href="manage-food-details.php?action=delete&&bsid=<?php echo $row['ID']; ?>"
