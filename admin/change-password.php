...
?>
    ...
    <head>
        <title>Food Donation Website|| Change Password </title>
                                            ...
                                            ?>
                                                ...
                                                <form class="cmxform form-horizontal " method="post" action="" name="changepassword" onsubmit="return checkpass();">
                                                    <div class="form-group ">
                                                        <label for="adminname" class="control-label col-lg-3">Current Password:
                                                        </label>
                                                        <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group ">
                                                        <label for="lastname" class="control-label col-lg-3">New
                                                            Password:</label>
                                                        <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group ">
                                                        <label for="username" class="control-label col-lg-3">Confirm
                                                            Password:</label>
                                                        <div class="col-lg-6">
