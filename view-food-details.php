                ...
                <div class="bs-docs-example">
                    <table class="table table-bordered" style="color:#000 !important;">
                        ...
                        <table border="1" class="table table-bordered mg-b-0">
                            ...
                            <?php if ($row['status'] == "") { ?>
                            <tr>
                                <td colspan="4"><button type="button" class="btn btn-info btn-lg" data-toggle="modal"
                                        data-target="#myModal">Request Food</button></td>
                            </tr>
                            <?php }  ?>
                        </table><?php } ?>
            ...
            <div class="modal-content">
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <p style="margin-top:1%"><input type="text" class="form-control" name="contactno"
                                placeholder="Mobile Number" pattern="[0-9]{10}" title="10 numeric characters only"
                                required></p>
                        <p style="margin-top:1%"><textarea name="message" class="form-control"
                                placeholder="Message if any"></textarea></p>
                        <p style="margin-top:2%"> <button type="submit" name="submit"
