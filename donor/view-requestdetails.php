...
?>
                            ...
                            <table border="1" class="table table-bordered mg-b-0">
                                ...
                                <tr>
                                    <th>Image</th>
                                    <td>
                                        <img src="../donor/images/<?php echo $row['Image']; ?>" width="200"
                                            height="200">
                                    </td>
...
;?></td>
                                <tr>
                                    <th colspan="4" style="text-align:center;color:red;font-size:20px;">Requested By
                                    </th>
                                </tr>
                                <tr>
                                    <th>Requested By</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="status" class="form-control wd-450" required="true">
                                                ...
                                                <option value="Food Take Away/ Request Completed">Food Take Away/
