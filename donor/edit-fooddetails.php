    ...
    $(document).ready(function() {
        ...
        $('#add').click(function() {
            ...
            $('#dynamic_field').append('<tr id="row' + i +
                '"><td><input type="text" name="fitem[]" placeholder="Enter Food Items" class="form-control name_list" /></td><td><button type="button" name="remove" id="' +
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal bucket-form" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <table class="table table-bordered" id="dynamic_field">
                                                    <tr>
                                                        <td><input type="text" name="fitem[]"
                                                                value="<?php echo $row['FoodItems']; ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea class="form-control" id="description" name="description"
                                                    type="text" required="true" value=""><?php echo $row['Description']; ?>
</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6"><?php echo $row['PickupDate']; ?>
                                                <input class="form-control" id="pdate" name="pdate" type="date"
                                                    required="true" value=">">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <select class="form-control m-bot15" name="state" id="state"
                                                    ...
                                                    <?php $query1 = mysqli_query($con, "select * from tblstate");
                                                            ...
                                                            ?>
                                                    <option value="<?php echo $row1['StateName']; ?>">
                                                        <?php echo $row1['StateName']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea type="text" class="form-control" name="address" id="address"
                                                    required="true"><?php echo $row['PickupAddress']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" name="cpmobnum" id="cpmobnum"
                                                    required="true" value="<?php echo $row['CPMobNumber']; ?>"
